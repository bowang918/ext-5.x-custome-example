/**
 * Created by bw79213 on 1/12/2016.
 */
/**
...
Ext.define('Ext.ux.form.field.CheckTag', {
     ...
     * @param {Ext.ux.form.field.CheckTag} this This field
    ...
    initComponent: function() {
        ...
        // This is the selection model for selecting tags in the checktag list. NOT the dropdown BoundList.
        // Create the selModel before calling parent, we need it to be available
        // when we bind the store.
        me.selectionModel = new Ext.selection.CheckboxModel({
            mode:'MULTI',
            onSelectChange: function(record, isSelected, suppressEvent, commitFn) {
                commitFn();
            },
    ...
    onTypeAhead: function() {
        ...
        if (record) {
            ...
            view.highlightItem(view.getRow(record));
    ...
    // Picked values are displayed by the checktag template.
