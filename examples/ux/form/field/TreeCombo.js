/**
 * Created by bw79213 on 1/26/2016.
 */
/**
...
Ext.define('Ext.ux.form.field.TreeCombo', {
    ...
    onBindStore: function (store, initial) {
        ...
        if (store) {
            ...
            me.pickerSelectionModel = new Ext.selection.TreeModel({
                ...
                listeners: {
                    scope: me,
                    beforedeselect: me.onBeforeSelect
                },
                scope: me
            });
    ...
    onBeforeSelect: function(selModel, record, index,e) {
        var me = this;
        if(me.onlyLeafSelected && record.childNodes && record.childNodes.length > 0) {
            return false;
        }
    }
});
